...
The included demo agent shows explicit one-shot constraint learning:
...
```
One-Shot LavaCrossing Benchmark
A rigorous test for catastrophe avoidance learning
...
1. Run the benchmark on your agent: `python test_lavacrossing_benchmark.py`
